...
branch: sprint/001
tasks:
- 011-cli-clean-errors
- 012-read-full-concept
- 002-default-bundle-cwd
- 010-query-csv-output
- 004-remove-id-virtual-field
- 007-schema-drop-type-mapping
- 001-choose-package-name
- 008-license-apache-2
created: 2026-07-09
